...
edits = itertools.groupby(data['query']['pages']['183903']['revisions'], lambda edit: edit['timestamp'].split('T')[0])
print('Всплеск правок пошел после смерти Градского')
for key, group in edits:
